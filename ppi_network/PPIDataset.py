...
def collate(samples):
    G_residue, go_embedding, pssm, G_residue2, go_embedding2, indexes2, labels = map(list, zip(*samples))
    return G_residue, go_embedding, pssm, G_residue2, go_embedding2, indexes2, torch.FloatTensor(labels)            
...
class PPIDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        G_residue, go_embedding, pssm = self.default_loader(p1) 
        G_residue2, go_embedding2, pssm2 = self.default_loader(p2)
        return G_residue, go_embedding, pssm, G_residue2, go_embedding2, pssm2, label
    ...
    def disk_loader(self,pid):
        ...
        return G_residue, go_embedding, norm_picked_pssm 